          ...
          <Grow in timeout={800}>
            <Card sx={{ borderRadius: { xs: 2, md: 4 }, boxShadow: { xs: 1, md: 3 } }}>
              <CardContent sx={{ textAlign: 'center', p: { xs: 2, md: 3 } }}>
                ...
                >
                  <Person sx={{ fontSize: { xs: 32, md: 60 } }} />
                </Avatar>
                ...
                <Button
                  variant="outlined"
                  color="primary"
                  sx={{ mt: 2, fontSize: { xs: '0.95rem', md: '1rem' }, px: { xs: 2, md: 3 }, py: { xs: 1, md: 1.2 }, width: { xs: '100%', md: 'auto' }, borderRadius: 3 }}
                ...
                <TabPanel value={value} index={0}>
                  <Box sx={{ display: 'flex', justifyContent: 'flex-end', mb: 2 }}>
                    <Button
                      ...
                      sx={{ fontSize: { xs: '0.95rem', md: '1rem' }, borderRadius: 3, px: { xs: 2, md: 3 }, py: { xs: 1, md: 1.2 } }}
                    >
                      Добавить заказ
                    </Button>
                  </Box>
                  <List sx={{ p: 0 }}>
                    {orders.map((order) => (
                      <Grow in timeout={800} key={order.id}>
                        <Card sx={{ mb: { xs: 1, md: 2 }, borderRadius: { xs: 2, md: 4 }, boxShadow: { xs: 1, md: 3 } }}>
                          <CardContent sx={{ p: { xs: 1, md: 2 } }}>
                            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'space-between', mb: 1, gap: { xs: 1, sm: 0 } }}>
                            ...
                            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'space-between', mt: 1, gap: { xs: 1, sm: 0 } }}>
                              <Typography variant="h6" color="primary.main" sx={{ fontSize: { xs: '1rem', md: '1.3rem' } }}>
                              ...
                              <IconButton color="error" onClick={() => handleDeleteOrder(order.id)} sx={{ ml: { xs: 0, sm: 2 } }}>
